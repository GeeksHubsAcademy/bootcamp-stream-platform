...
export async function postRegister(name, lastname, email, password, password2) {
  //let response = await Axios.post('http://localhost:3001/register/', {name,lastname,email,password,password2} );
}
